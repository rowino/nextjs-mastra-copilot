/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c20fb0b3285120fdda741fea8058b5b0)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_LARAVEL_API_URL: string;
